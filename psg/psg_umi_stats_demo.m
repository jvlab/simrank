% psg_umi_stats_demo: demonstrate psg_umi_stats
%
% 20Feb23: add psg_data_dir
%
%   See also:  PSG_UMI_STATS, PSG_TENT_STATS_DEMO, PSG_SPOKES_SETUP.
%
if ~exist('sessfiles') 
...
for k=1:length(sessfiles)
    ...
    umi_stats{k}.results=psg_umi_stats(s.sessions,setfields(opts,{'if_log','if_cumulative'},{if_log,if_cumulative}));    
end
